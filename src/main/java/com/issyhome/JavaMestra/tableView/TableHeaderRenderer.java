 ...
 * It renderer as the search status.
 *
...
public class TableHeaderRenderer extends DefaultTableCellRenderer {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -6816596272210481204L;
    ...
    public TableHeaderRenderer() {
        ...
        setBorder(new javax.swing.border.CompoundBorder(getBorder(),
                new javax.swing.border.EmptyBorder(0, mNull.getIconWidth(), 0, 0)));
    }
    ...
    public Component getTableCellRendererComponent(JTable pTable,
        ...
        if (pTable != null) {
            ...
            if (header != null) {
                ...
                setFont(font);
                // December 2008 : add a default tool tip
                this.setToolTipText("click on the header to sort the column content");
            }
        }
    ...
    /**
     * An empty icon with the same size.
     */
    ...
    /**
     * Invert the bright value as needed
     * @param pBright the bright value
     * @param pNeed is need
     * @return float the new bright value
     */
