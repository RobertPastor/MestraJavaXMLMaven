...
public abstract class AbstractTableViewModel  implements   TableViewModel,  Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8538516149769167783L;
	/**
     * List of listeners
     */
     ...
     * @see EventListenerList
     */
    protected void fireTableRowsInserted(Collection<Object> pRowObjects) {
     ...
     * @see EventListenerList
     */
    protected void fireTableRowsUpdated(Collection<Object> pRowObjects) {
        fireTableChanged(new TableViewModelEvent(this, pRowObjects,
     ...
     * @see EventListenerList
     */
    protected void fireTableRowsDeleted(Collection<Object> pRowObjects) {
        fireTableChanged(new TableViewModelEvent(this, pRowObjects,
     ...
     *
     * @param pListenerType Listener class type
     * @return all of the objects receiving <code>listenerType</code> notifications from this model
     */
    public EventListener[] getListeners(Class<EventListener> pListenerType) {
